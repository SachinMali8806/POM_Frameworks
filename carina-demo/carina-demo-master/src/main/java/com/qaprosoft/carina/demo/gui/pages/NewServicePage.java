...
public class NewServicePage extends AbstractPage {
	...
	//Service Details
	//div[@title='Service Details']
	  @FindBy(xpath = "//div[@title='Service Details']")
	    private ExtendedWebElement serviceDetails;
	
	
	 //Service FMIS Code
	//label[text()='Service FMIS Code']/../../../tr[2]//input
    @FindBy(xpath = "//label[text()='Service FMIS Code']/../../../tr[2]//input")
    private ExtendedWebElement serviceFMISCode;
    
    //416105 - Accrued Salaries-Ministry of Foreign Affairs
  //li[text()='416105 - Accrued Salaries-Ministry of Foreign Affairs']
    
     final String str="416105 - Accrued Salaries-Ministry of Foreign Affairs";
    final String str1="//li[text()='%s']";
    @FindBy(xpath = str1)
    private ExtendedWebElement serviceFMIScodeSelect;
  ...
  //label[text()='Service Owner']/../../../tr[2]/td/input
	...
	public Boolean serviceDetailsDisplayed()
	{
		 return serviceDetails.isVisible();
		
	}
	
	public void typeFMISCode(String Service_FMIS_Code)
	{
		String fmis = Service_FMIS_Code.substring(0, 3);
		serviceFMISCode.type(fmis);
		
	}
	
	public void selectServiceFMISCode(String service_FMIS_Code)
	{
		
		serviceFMIScodeSelect.format(service_FMIS_Code).clickIfPresent();
	}
